...
window.alert("Also remember that time I was hella drunk and kept telling you I liked you?")
window.alert("how embarrassing")
window.alert("but true ;)")
...
var r = confirm("Do you want to hear a story about dogs?")
if (r == true) {
